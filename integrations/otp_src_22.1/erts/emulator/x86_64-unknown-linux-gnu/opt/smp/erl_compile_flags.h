...
const char* erts_build_flags_CFLAGS = "-Werror=undef -Werror=implicit -Werror=return-type  -g -O2 -I/home/rsewell/Projects/Epilogue/integrations/otp_src_22.1/erts/x86_64-unknown-linux-gnu   -fno-tree-copyrename  -D_GNU_SOURCE  -DHAVE_CONFIG_H -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS -D_POSIX_THREAD_SAFE_FUNCTIONS  ";
const char* erts_build_flags_CONFIG_H = "/* x86_64-unknown-linux-gnu/config.h.  Generated from config.h.in by configure.  */\n\
