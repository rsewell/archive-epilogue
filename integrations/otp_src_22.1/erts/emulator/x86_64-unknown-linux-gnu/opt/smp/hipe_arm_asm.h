...
/* #define NBIF_ARG_4_0	# mov	r1, r1 */
/* #define NBIF_ARG_4_1	# mov	r2, r2 */
/* #define NBIF_ARG_4_2	# mov	r3, r3 */
/* #define NBIF_ARG_4_3	ldr	r4, [NSP, #0] */
...
/* #define NBIF_RET_4	add	NSP, NSP, #4
	mov pc, TEMP_LR */
